...
function Freaquently() {
  return (
    ...
    <div style={{marginTop:"12%"}}>
              ...
              <Accordion className='container ' style={{marginTop:'-12px'}} defaultActiveKey="1">
                    <Accordion.Item eventKey="0">
                        <Accordion.Header><b className='ft'>1. How can I find where my package is?</b></Accordion.Header>
                        <Accordion.Body>
                            <div>
                                <p>It's simple! Just type your tracking number on our website, and you'll see real-time updates about where your package is and when it will be delivered </p>
