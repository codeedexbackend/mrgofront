  ...
  return (
    <div className="App">
      <Routes location={location}>
        ...
        <Route path="/productfinal/:userId/:invoice" element={<ProductFinal />} />
        <Route path="/Profile" element={<Profile />} />
        <Route path="/admin/*" element={<AdminRoute element={<Ahome />} />} />
        <Route path="/admin/user" element={<AdminRoute element={<UserControl />} />} />
        <Route path="/admin/:userId" element={<AdminRoute element={<User />} />} />
        <Route path="/admin/Billing" element={<AdminRoute element={<Billing />} />} />
        <Route path="/admin/Track" element={<AdminRoute element={<Atrack />} />} />
        <Route path="/admin/Booking" element={<AdminRoute element={<Booking />} />} />
        <Route path="/admin/Login" element={<LoginForm />} />
        <Route path="/admin/Notification" element={<AdminRoute element={<Notification />} />} />
        <Route path="/admin/Acontact" element={<AdminRoute element={<Acontact />} />} />
        <Route path="/admin/Astatus" element={<AdminRoute element={<Astatus />} />} />
        <Route path="/admin/Acontact/:id" element={<AdminRoute element={<ContactDetails />} />} />
        <Route path="/admin/Product/:id" element={<AdminRoute element={<ProductList />} />} />
        <Route path="/admin/Trackorder" element={<AdminRoute element={<TrackingOrder />} />} />
        <Route path="/orders/:id" element={<MyOrders />} />
        <Route path="/label/:userId/:orderId" element={<Label />} />
        <Route path="/product/:userId/:invoice" element={<AdminRoute element={<InProduct />} />} />
...
<Route path="/new-password" element={<Password></Password>} ></Route>
        ...
        <Route path="/admin/invoice/:userId/:invoice" element={<AdminRoute element={<Billingprint />} />} />
      </Routes>
    </div>
  );
}
